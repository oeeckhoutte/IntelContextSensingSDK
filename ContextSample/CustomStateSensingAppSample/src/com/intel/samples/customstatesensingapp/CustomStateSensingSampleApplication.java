 ...
 * state by using the context type URI identifier. This scenario is 
...
public class CustomStateSensingSampleApplication extends Application {
    ...
    private class CustomStateListener implements ContextTypeListener {
        ...
        public void onReceive(Item state) {
            String customStateValue = ItemHelper.getStateValue(state);
            Log.d(LOG_TAG, "New Custom State: " + customStateValue);
            Toast.makeText(getApplicationContext(),
                    "New Custom State! \n" + customStateValue, Toast.LENGTH_LONG).show();
        }
