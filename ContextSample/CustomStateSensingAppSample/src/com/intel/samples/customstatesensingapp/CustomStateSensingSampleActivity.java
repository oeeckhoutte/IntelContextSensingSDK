...
public class CustomStateSensingSampleActivity extends Activity {
    ...
    private void startSensing() {
        ...
        try {
            /*
             * Enable the sensing of this specific custom state, identified as
             * "urn:x-intel:context:type:custom:ringermode". 
             * Settings are not required for this custom state provider.
             */
            mySensing.enableSensing("urn:x-intel:context:type:custom:ringermode", bundle);
            Toast.makeText(getApplicationContext(),
	...
	private void addListener() {
        try {
             ...
             */
            mySensing.addContextTypeListener("urn:x-intel:context:type:custom:ringermode", myListener);
            Toast.makeText(getApplicationContext(),
	...
	private void stopSensing(){
        try {
            /*
             * Disable the sensing of the custom state using the URI identifier.
             */
            mySensing.disableSensing("urn:x-intel:context:type:custom:ringermode");
            Toast.makeText(getApplicationContext(),
