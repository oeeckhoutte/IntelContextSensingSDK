...
#include "cac/clientapi/iaccessor.h"
#include "cac/clientapi/isubscription.h"
#include "MyObserver.h"

using namespace ContextFramework;

class SimpleRuleContextSource : public ISourceAccess
{ 
    CONTEXTFRAMEWORK_DECLARE_ICFOBJECT_FIELDS;

public:
    SimpleRuleContextSource(ContextFramework::ISourceEngineAccess* engine);
    ~SimpleRuleContextSource();
...
private:
	...
	ContextFramework::ISourceEngineAccess* m_engine;
    ContextFramework::String GetRandomNumber();
	ContextFramework::ISubscription *	m_subscription;
	DataSetIdent            m_subsDataSet;
